...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    public static void sendFeedback(Context context) {
        ...
        try {
            ...
            body = "\n\n-----------------------------\nPor favor nao remova essa informacao\n Device OS: Android \n Device OS version: " +
        ...
        intent.putExtra(Intent.EXTRA_EMAIL, new String[]{"contact@mbelamova.info"});
        intent.putExtra(Intent.EXTRA_SUBJECT, "Query fromUser android app");
