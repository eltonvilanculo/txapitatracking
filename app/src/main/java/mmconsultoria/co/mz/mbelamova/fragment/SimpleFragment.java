...
public abstract class SimpleFragment extends Fragment {
    ...
    protected PieData generatePieData() {
        ...
        for(int i = 0; i < count; i++) {
            if(i==0){
                entries1.add(new PieEntry((int) (4), "Efectuadas " ));
            }else if (i==1){
                entries1.add(new PieEntry((int) (1), "Agendadas " ));
            }else if (i==2){
                entries1.add(new PieEntry((int) (2), "Camceladas " ));
            }else if (i==3){
                entries1.add(new PieEntry((int) (0), "Perdidas" ));
            }

        }

        PieDataSet ds1 = new PieDataSet(entries1, "powerd by M.M.H");
